 ...
 * @author:
 */
public class HttpPostEvento extends AsyncTask<String, Void, String> {
    private Context context;
    private String data;
    private Solicitar_evento ni;

    /**
     * Constructor
     */
    public HttpPostEvento(Context context, String data,Solicitar_evento ni) {
